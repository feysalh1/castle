...
sed -i.bak \
    ...
    -e "s|_FIREBASE_AUTH_DOMAIN: 'story-time-fun.firebaseapp.com'|_FIREBASE_AUTH_DOMAIN: '$FIREBASE_AUTH_DOMAIN'|g" \
    -e "s|_FIREBASE_STORAGE_BUCKET: 'story-time-fun.appspot.com'|_FIREBASE_STORAGE_BUCKET: '$FIREBASE_STORAGE_BUCKET'|g" \
    -e "s|_FIREBASE_MESSAGING_SENDER_ID: ''|_FIREBASE_MESSAGING_SENDER_ID: '$FIREBASE_MESSAGING_SENDER_ID'|g" \
    -e "s|_FIREBASE_APP_ID: ''|_FIREBASE_APP_ID: '$FIREBASE_APP_ID'|g" \
    -e "s|_FIREBASE_MEASUREMENT_ID: ''|_FIREBASE_MEASUREMENT_ID: '$FIREBASE_MEASUREMENT_ID'|g" \
